...
STRINGS = {
    "es": {
        ...
        "cmd_keep": "guarda el transcript entero para retomarlo en otra máquina",
        "cmd_resume": "trae acá un transcript guardado y lo deja retomable",
        ...
        "brought": "traída: {id}",
        "keep_title": "guardar la conversación entera",
        "keep_what": "El repo guarda un resumen recortado: sirve para leer, no para retomar.",
        "keep_how": "Esto archiva el transcript completo, comprimido, para que otra máquina lo continúe.",
        "kept_ok": "guardada {id} · {kb} KB — sincronizala con push",
        "keep_only_local": "{id}: solo se puede guardar una sesión de esta máquina",
        "keep_already": "{id} ya estaba guardada",
        "resume_title": "traer la conversación a esta máquina",
        "resume_what": "Se escribe en {path}",
        "resume_how": "Después se retoma con:  claude --resume {id}",
        "resumed_ok": "{short} lista · claude --resume {id}",
        "resume_needs_keep": "{id}: no está guardada — hay que guardarla en la máquina que la tiene",
        ...
        "k_change": "cambiar",
        "tui_ground": "Fondo", "ground_dark": "oscuro", "ground_light": "claro",
        "ground_black": "negro puro",
        "k_move": "mover",
        "usage_daily": "gasto por día",
        "show_all": "todos", "confirm_go": "confirmar", "confirm_no": "cancelar",
        "k_search": "buscar", "k_bring": "traer", "k_delete": "borrar de acá",
        "k_forget": "sacar del repo", "k_all": "todos",
        "k_keep": "guardar entera", "col_kept": "guard",
        "tab_skills": "Skills", "tab_tools": "Tools", "sec_kinds": "Tipo",
        ...
        "col_title": "título", "col_slug": "memoria", "col_desc": "descripción",
        "col_total": "total", "tab_graph": "Grafo", "sec_detail": "Detalle",
        "k_graph": "abrir el grafo en una ventana",
        "textual_missing": "sto ui necesita textual: instalá uv (https://astral.sh/uv) o `pip install textual`",
    ...
    "en": {
        ...
        "cmd_keep": "archive a full transcript so another machine can resume it",
        "cmd_resume": "bring an archived transcript here and make it resumable",
        ...
        "brought": "brought: {id}",
        "keep_title": "keep the whole conversation",
        "keep_what": "The repo holds a trimmed copy: fine to read, useless to resume.",
        "keep_how": "This archives the full transcript, compressed, so another machine can continue it.",
        "kept_ok": "kept {id} · {kb} KB — sync it with push",
        "keep_only_local": "{id}: only a session from this machine can be kept",
        "keep_already": "{id} was already kept",
        "resume_title": "bring the conversation to this machine",
        "resume_what": "Written to {path}",
        "resume_how": "Then continue it with:  claude --resume {id}",
        "resumed_ok": "{short} ready · claude --resume {id}",
        "resume_needs_keep": "{id}: not archived — keep it on the machine that has it",
        ...
        "k_change": "change",
        "tui_ground": "Background", "ground_dark": "dark", "ground_light": "light",
        "ground_black": "pure black",
        "k_move": "move",
        "usage_daily": "spend per day",
        "show_all": "all", "confirm_go": "confirm", "confirm_no": "cancel",
        "k_search": "search", "k_bring": "bring", "k_delete": "delete here",
        "k_forget": "drop from repo", "k_all": "all",
        "k_keep": "keep in full", "col_kept": "kept",
        "tab_skills": "Skills", "tab_tools": "Tools", "sec_kinds": "Kind",
        ...
        "col_title": "title", "col_slug": "memory", "col_desc": "description",
        "col_total": "total", "tab_graph": "Graph", "sec_detail": "Detail",
        "k_graph": "open the graph in a window",
        "textual_missing": "sto ui needs textual: install uv (https://astral.sh/uv) or `pip install textual`",
...
CLI_STRINGS = {
    "es": {
        ...
        "cli_use_keep": "uso: sto keep <id> (probá: sto sessions)",
        "cli_kept": "guardada {id} · {project} · {kb} KB — hacé `sto push` y después `sto resume {id}` en la otra máquina",
        "cli_use_resume": "uso: sto resume <id> (probá: sto sessions)",
        "cli_resumed": "{id} traída de {machine} · {n} líneas — continuala con:",
    ...
    "en": {
        ...
        "cli_use_keep": "usage: sto keep <id> (try: sto sessions)",
        "cli_kept": "kept {id} · {project} · {kb} KB — run `sto push`, then `sto resume {id}` on the other machine",
        "cli_use_resume": "usage: sto resume <id> (try: sto sessions)",
        "cli_resumed": "{id} brought over from {machine} · {n} lines — continue it with:",
