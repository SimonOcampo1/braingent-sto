...
STRINGS = {
    "es": {
        ...
        "textual_missing": "instalá uv (https://astral.sh/uv) o `pip install textual` — abriendo la interfaz de siempre",
    ...
    "en": {
        ...
        "textual_missing": "install uv (https://astral.sh/uv) or `pip install textual` — opening the usual front-end",
