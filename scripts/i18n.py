...
STRINGS = {
    "es": {
        ...
        "step2": "2. git remote rename origin upstream",
        "step3": "3. git remote add origin git@github.com:<vos>/<repo>.git",
        "step3b": "4. git push -u origin main   ·   después PUSH acá",
        "sub_each_machine": "En cada máquina más",
        "step4": "1. git clone <tu repo privado>",
        "step5": "2. corré scripts/install_sto_cli.ps1 adentro del clon",
        "step6": "3. PULL · desde ahí PUSH y PULL las mantienen iguales",
        ...
        "k_home": " ↑↓ mover  ↵ abrir  Tab sección  p push  l pull  u update  q salir",
    ...
    "en": {
        ...
        "step2": "2. git remote rename origin upstream",
        "step3": "3. git remote add origin git@github.com:<you>/<repo>.git",
        "step3b": "4. git push -u origin main   ·   then PUSH here",
        "sub_each_machine": "On every other machine",
        "step4": "1. git clone <your private repo>",
        "step5": "2. run scripts/install_sto_cli.ps1 inside the clone",
        "step6": "3. PULL · from then on PUSH and PULL keep them equal",
        ...
        "k_home": " ↑↓ move  ↵ open  Tab section  p push  l pull  u update  q quit",
